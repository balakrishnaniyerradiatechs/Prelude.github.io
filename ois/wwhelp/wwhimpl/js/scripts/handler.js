...
function  WWHHandler_Finalize()
{
  ...
  // Preload graphics
  //
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_bg.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_bgx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_e.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_ex.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_n.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_ne.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_nex.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_nw.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_nwx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_nx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_s.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_se.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_sex.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_sw.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_swx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_sx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_w.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/btn_wx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/navbg.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_e.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_n.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_s.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_sx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_tabl.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_tabm.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_tabr.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_top.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_topx.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/spc_w.gif";
  this.mImages[this.mImages.length] = new Image(); this.mImages[this.mImages.length - 1] = VarImageDirectory + "/viewbg.gif";
